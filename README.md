...
3. Для каждой карточки:
   ...
   - извлекает артикул,
   - извлекает главное изображение товара (приоритет: `img.product-detail-gallery__picture.rounded3.zoom_picture.lazyloaded`, обычно 800x800, без технических картинок/иконок).
...
- Кнопка запуска формирования отчетов расположена под полем ввода URL раздела.
- Кнопка **«Стоп»** для остановки обработки.
- Блок логов расположен внизу интерфейса.
- Скачивание:
